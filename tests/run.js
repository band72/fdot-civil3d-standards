...
const SUITES = ["cogo", "data", "dxf", "linework", "efbk", "landxml", "batchprocess", "stdn-cmp", "auth", "geo", "marketing"];
...
(async () => {
    ...
    t.eq(loadRes.loaded.length, 24, "24 source files loaded");
    ["COGO", "FDOT_DATA", "FDOTDXFInspector", "PluginRegistry", "BoundaryQCSecurity",
        "BoundaryQCBilling", "BoundaryQCCMS", "Linework", "EFBK", "LandXML", "BatchProcess", "StdnEngine", "StdnCompare", "safeHTML", "setSafeRows"]
